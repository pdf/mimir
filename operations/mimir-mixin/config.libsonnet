{
  ...
  _config+:: {
    ...
    job_names: {
      ...
      distributor: '(m3-aggregations-)?(distributor|cortex|mimir)',
      ...
      ring_members: ['compactor', '(m3-aggregations-)?distributor', 'ingester.*', 'querier.*', 'ruler', 'store-gateway.*', 'cortex', 'mimir'],
    ...
    instance_names: {
      ...
      ingester: 'ingester.*',
      distributor: '(m3-aggregations-)?distributor.*',
      querier: 'querier.*',
      ruler: 'ruler.*',
